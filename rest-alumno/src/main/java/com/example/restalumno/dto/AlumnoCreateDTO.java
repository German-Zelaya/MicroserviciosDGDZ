...
// ========== AlumnoCreateDTO.java ==========
@Schema(description = "DTO para crear un nuevo alumno")
public class AlumnoCreateDTO {
    ...
    public AlumnoCreateDTO(String nombre, String apellido, Integer edad, String email, String telefono, String direccion) {
        this.nombre = nombre;
